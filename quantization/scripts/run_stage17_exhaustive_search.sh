...
OUTPUT_DIR="${QUANT_ROOT}/quantization_outputs/stage17_exhaustive"
...
echo "=================================================="
echo "Stage 17 (InternVL-U): Sublayer-Level Exhaustive CKA Search"
echo "=================================================="
...
CMD="python -u ${QUANT_ROOT}/stages/stage17_sublayer_exhaustive_search.py search \
...
echo ""
LOG_FILE="$OUTPUT_DIR/stage17_log_${RUN_DATE}.txt"
eval $CMD 2>&1 | tee "$LOG_FILE"

echo ""
echo "Stage 17 completed! (run_date=${RUN_DATE})"
